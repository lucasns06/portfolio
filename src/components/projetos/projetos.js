...
const Projetos = () => {
    ...
    const slide = [
        ...
        },
        {
            ...
            texto2: 'O projeto utiliza ASP.NET Core e Entity Framework Core, conta com um banco de dados e autenticação de usuarios.',
                        ...
                        <a href={item.link} className="swiper-container sombra">
                            ...
                            <div className="back2">
                                <div className="swiper-texto">
                                    ...
                                    <p>{item.texto2}</p> 
                                    <br />
                                    <p style={{textAlign: 'center', color: 'lightgreen'}}>Clique para abrir o projeto</p>
                                </div>
                                <a className="cardGithub" href={item.github} target="_blank" rel="noopener noreferrer">
